...
{
    public partial class Tickets_Resolved : System.Web.UI.Page
    {
        ...
        public static Hashtable AllLoadDetails(Hashtable ht, string Type, string Req)
        {
            try
            {
                ...
                if (Type == "Fill")
                {
                    ...
                    {
                        ds = db.SysFetchDataInDataSet("[TicketAgentResolved_Get]", ht_param);
                    }
                    else
                    {
                        ds = db.SysFetchDataInDataSet("[TicketAdminResolved_Get]", ht_param);
                    }

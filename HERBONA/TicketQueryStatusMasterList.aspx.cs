...
{
    public partial class TicketQueryStatusMasterList : System.Web.UI.Page
    {
        ...
        static List<PaymentModelistModel> _gstlistModel = new List<PaymentModelistModel>();
        ...
        public static Hashtable AllLoadDetails(Hashtable ht, string Type, string Req)
        {
            try
            {
                ...
                if (Type == "Fill")
                {
                    ...
                    ds = db.SysFetchDataInDataSet("[GET_TicketQueryStatusMaster]", ht_param);
                ...
                if (Type == "setStatus")
                {
                    ...
                    ht_param.Add("@Company_ID", HttpContext.Current.Session["Company_ID"].ToString());
                    ht_param.Add("@Branch_ID", HttpContext.Current.Session["Branch_ID"].ToString());
                    ds = db.SysFetchDataInDataSet("[SAVE_UPDATE_TicketQueryStatusMaster]", ht_param);
                    if (ds.Tables.Count > 0)
                    {

<%@ Page Title="" Language="C#" MasterPageFile="~/SmartTruck.Master" AutoEventWireup="true" CodeBehind="Branch_Profile.aspx.cs" Inherits="SmartTrucking.Branch_Profile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="col-md-9">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#settings" data-toggle="tab">Branch Profile</a></li>
                    </ul>
                        ...
                        <div class="active tab-pane" id="settings">
                            <form class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="txtHOD" class="form-control" type="text" placeholder="Branch Name." />
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="inputSkills" class="col-sm-2 control-label">Location Name<span class="reqstar">*</span></label>

                                    <div class="col-sm-10">
                                        <input id="txtCBranchName" class="form-control" type="text" placeholder="Location Name." />
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        <button type="button" id="btnupdate" class="btn btn-danger" onclick="UpdateBranch()">Update</button>
    ...
    <script src="ClientJS/BranchProfile.js"></script>
    <script>
        $(function () {
            $(".select2").select2();
        });

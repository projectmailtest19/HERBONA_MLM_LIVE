<%@ Page Title="" Language="C#" MasterPageFile="~/SmartTruck.Master" AutoEventWireup="true" CodeBehind="BonusWalletSummary.aspx.cs" Inherits="SmartTrucking.BonusWalletSummary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Bonus Wallet Summary</h3>
    ...
    <script src="ClientJS/BonusWalletSummary.js"></script>
    <script>
        $(function () {
            $(".select2").select2();
        });

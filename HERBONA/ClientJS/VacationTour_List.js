...
function GetLoadDetails() {
    Req = 'LoadList';
    obj = "Fill";
    url = "VacationTour_List.aspx/AllLoadDetails";
    ht = {};
    ...
    $.ajax({
        ...
        success: function (Result) {
            ...
            if (obj == "Fill") {
                ...
                table = table + '<thead><tr><th style="display:none">ID</th><th>TOUR NAME</th><th>LEFT POINT</th><th>LEFT POINT DETAIL</th><th>RIGHT POINT</th><th>RIGHT POINT DETAIL</th><th>Status</th><th  class=' + _allowedit + '>Edit</th><th  class=' + _allowdelete + '>Delete</th></tr></thead> <tbody>';
                $.each(data, function (i, item) {
                    ...
                    table = table + "<tr><td style='display:none' >" + item.ID +
                                    "</td><td>" + item.TOUR_NAME +
                                    "</td><td>" + item.LEFT_POINT +
                                    "</td><td>" + item.LEFT_POINT_DETAIL+
                                    "</td><td>" + item.RIGHT_POINT +
                                    "</td><td>" + item.RIGHT_POINT_DETAIL +

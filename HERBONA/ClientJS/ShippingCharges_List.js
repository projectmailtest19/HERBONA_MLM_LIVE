...
function GetLoadDetails() {
    Req = 'LoadList';
    obj = "Fill";
    url = "ShippingCharges_List.aspx/AllLoadDetails";
    ht = {};
    ...
    $.ajax({
        ...
        success: function (Result) {
            ...
            if (obj == "Fill") {
                ...
                table = table + '<thead><tr><th style="display:none">ID</th><th>DISTRICT NAME</th><th>CHARGE PERCENTAGE</th><th>CHARGE AMOUNT</th><th>Status</th><th  class=' + _allowedit + '>Edit</th><th  class=' + _allowdelete + '>Delete</th></tr></thead> <tbody>';
                $.each(data, function (i, item) {
                    ...
                    table = table + "<tr><td style='display:none' >" + item.ID +
                                    ...
                                    "</td><td>" + item.CHARGE_PERCENTAGE +
                                    "</td><td>" + item.CHARGE_AMOUNT +                                  
...
function redirect() {
    window.location = 'CreateShippingCharges.aspx';
}


function LoadEdit(id) {
    var bt = btoa("id=" + id + "");
    window.location = 'CreateShippingCharges.aspx?' + bt;
}

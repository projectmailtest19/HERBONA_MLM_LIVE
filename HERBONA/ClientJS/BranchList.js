    ...
    $.ajax({
        ...
        success: function (Result) {
            ...
            if (obj == "Fill") {
                ...
                table = table + '<thead><tr><th style="display:none">Branch ID</th><th>Branch Name</th><th>Company Name</th><th>Phone#</th><th>Email ID</th><th>Address</th><th  class=' + _allowedit + '>Edit</th><th  class=' + _allowedit + '>Profile</th><th  class=' + _allowdelete + '>Status</th><th style="display:none">Proceed</th></tr></thead> <tbody>';
                $.each(data, function (i, item) {
                    ...
                    table = table + "<tr><td style='display:none' >" + item.ID +
                                    ...
                                    "<td style='display:none'> <input class='btn-success btn ' onclick=Proceed(" + item.Contact_ID + ") type='button'  value='Proceed ' /></td></tr>"
                });

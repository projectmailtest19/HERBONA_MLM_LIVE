...
function GetLoadDetails() {
    Req = 'LoadList';
    obj = "Fill";
    url = "gst_list.aspx/AllLoadDetails";
    ht = {};
    ...
    $.ajax({
        ...
        success: function (Result) {
            ...
            if (obj == "Fill") {
                ...
                table = table + '<thead><tr><th style="display:none">ID</th><th>CGST_PERCENTAGE</th><th>SGST_PERCENTAGE</th><th>IGST_PERCENTAGE</th><th>Status</th><th  class=' + _allowedit + '>Edit</th><th  class=' + _allowdelete + '>Delete</th></tr></thead> <tbody>';
                $.each(data, function (i, item) {
                    ...
                    table = table + "<tr><td style='display:none' >" + item.ID +
                                    "</td><td>" + item.CGST_PERCENTAGE +
                                    "</td><td>" + item.SGST_PERCENTAGE +
                                    "</td><td>" + item.IGST_PERCENTAGE +

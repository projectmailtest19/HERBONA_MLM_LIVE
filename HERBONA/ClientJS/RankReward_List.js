...
function GetLoadDetails() {
    Req = 'LoadList';
    obj = "Fill";
    url = "RankReward_List.aspx/AllLoadDetails";
    ht = {};
    ...
    $.ajax({
        ...
        success: function (Result) {
            ...
            if (obj == "Fill") {
                ...
                table = table + '<thead><tr><th style="display:none">ID</th><th>NAME</th><th>START</th><th>LEFT SIDE</th><th>RIGHT SIDE</th><th>REWARDS DETAIL</th><th>Status</th><th  class=' + _allowedit + '>Edit</th><th  class=' + _allowdelete + '>Delete</th></tr></thead> <tbody>';
                $.each(data, function (i, item) {
                    ...
                    table = table + "<tr><td style='display:none' >" + item.ID +
                                    "</td><td>" + item.NAME +
                                    "</td><td>" + item.START +
                                    "</td><td>" + item.LEFT_SIDE +
                                    "</td><td>" + item.RIGHT_SIDE +
                                    "</td><td>" + item.REWARDS_DETAIL +
...
function redirect() {
    window.location = 'CreateRankReward.aspx';
}


function LoadEdit(id) {
    var bt = btoa("id=" + id + "");
    window.location = 'CreateRankReward.aspx?' + bt;
}

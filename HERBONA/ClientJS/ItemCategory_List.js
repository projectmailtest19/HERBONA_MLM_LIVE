...
function GetLoadDetails() {
    Req = 'LoadList';
    obj = "Fill";
    url = "ItemCategory_List.aspx/AllLoadDetails";
    ht = {};
    ...
    $.ajax({
        ...
        success: function (Result) {
            ...
            if (obj == "Fill") {
                ...
                table = table + '<thead><tr><th style="display:none">ID</th><th>NAME</th><th>CODE</th><th>Status</th><th  class=' + _allowedit + '>Edit</th><th  class=' + _allowdelete + '>Delete</th></tr></thead> <tbody>';
...
function redirect() {
    window.location = 'CreateItemCategory.aspx';
}


function LoadEdit(id) {
    var bt = btoa("id=" + id + "");
    window.location = 'CreateItemCategory.aspx?' + bt;
}

...
function GetLoadDetails() {
    Req = 'LoadList';
    obj = "Fill";
    url = "CreateSessionList.aspx/AllLoadDetails";
    ht = {};
    ...
    $.ajax({
        ...
        success: function (Result) {
            ...
            if (obj == "Fill") {
                ...
                table = table + '<thead><tr><th style="display:none">ID</th><th>Session Name</th><th>from_date</th><th>to_date</th><th>Status</th><th  class=' + _allowedit + '>Edit</th><th  class=' + _allowdelete + '>Delete</th></tr></thead> <tbody>';
                $.each(data, function (i, item) {
                    ...
                    table = table + "<tr><td style='display:none' >" + item.ID +
                                    "</td><td>" + item.Session_Name +
                                     "</td><td>" + item.from_date +
                                      "</td><td>" + item.to_date +
...
function redirect() {
    window.location = 'CreateSession.aspx';
}


function LoadEdit(id) {
    var bt = btoa("id=" + id + "");
    window.location = 'CreateSession.aspx?' + bt;
}
